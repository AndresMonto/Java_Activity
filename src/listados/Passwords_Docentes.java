...
public class Passwords_Docentes extends javax.swing.JInternalFrame {
    ...
    private void consulta() {
        cone.tabla3("select *from docentes_pass  ", "codDoc", "nomUsu", "DECRYPT", jTable1);
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("CONTRASEÑAS");
        getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jPanel2.setBackground(new java.awt.Color(51, 153, 255));
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "DOCENTES", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 14), new java.awt.Color(0, 0, 204))); // NOI18N
        ...
        jLabel7.setText("CONTRASEÑAS DE LOS USUARIOS: ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            JasperReport report = JasperCompileManager.compileReport("src/listados/jasper/Paswords_Docentes.jrxml");
            JasperPrint print = JasperFillManager.fillReport(report, parametro, conn);
            JasperExportManager.exportReportToPdfFile(print, "Reportes/Passwords/Passwords de Docentes"+nombre+".pdf");
