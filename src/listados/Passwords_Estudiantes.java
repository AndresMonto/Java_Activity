...
public class Passwords_Estudiantes extends javax.swing.JInternalFrame {
    ...
    private void consulta() {
        cone.tabla3("select *from estudiantes_pass  ", "codEst", "nomUsu", "DECRYPT", jTable1);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            JasperReport report = JasperCompileManager.compileReport("src/listados/jasper/Paswords_Estudiantes.jrxml");
            JasperPrint print = JasperFillManager.fillReport(report, parametro, conn);
            JasperExportManager.exportReportToPdfFile(print, "Reportes/Passwords/Passwords de Estudiantes"+nombre+".pdf");
