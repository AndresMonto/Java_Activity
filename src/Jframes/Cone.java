...
public class Cone {
    ...
    public Cone() {
        try {
            ...
            conex = DriverManager.getConnection("jdbc:mysql://localhost:3306/registro", "andres", "196994");
...
//            }
    ...
    public void inicio(String sql, String col, JTextField campo, JTextField borrar) {
